...
/**
 * Downscale/compress an image buffer for OCR upload. Plate Recognizer rejects
 * anything over 3.5MB, and modern phone photos routinely exceed that. This
 * only affects the copy sent to the OCR provider — EXIF extraction and any
 * photo retained for review (e.g. Surveyor Mode drafts) still use the
 * original, untouched buffer, so GPS tags and photo quality shown to the
 * moderator are unaffected.
 */
